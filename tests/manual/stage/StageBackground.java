...
public class StageBackground extends Application {
    public static void main(String[] args) {
        launch(StageBackground.class, args);
    }
    ...
    private void buildScene(Stage stage, StageStyleChoice stageStyle) {
        ...
        createButton.setOnAction(e -> {
            createAndShowStage(stageStyleChoice.getValue());
        });

        HBox stageCreationControls = new HBox(stageStyleChoice, createButton);
        ...
        VBox controls = new VBox(
            labeledSection("This stage is " + stageStyle),
    ...
    private void showStage(Stage stage, StageStyleChoice style)
    {
        stage.setTitle(style.toString());
        stage.initStyle(style.getStageStyle());
        buildScene(stage, style);
        stage.show();
    }

    private void createAndShowStage(StageStyleChoice style)
    {
